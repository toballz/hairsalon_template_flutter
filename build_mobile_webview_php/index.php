<?php include_once("../../co.php");$rS="02dsdx1qsq";
        ...
        <section data-pageswitchref="settings">
            <div class="container mt-5">
                <div class="list-group settingsj">
                    ...
                    <br />
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action" onclick="sharparp.push({title: 'href',value: 'https://stripe.com'});">
                        <i class="bi bi-globe"></i> View payments - stripe.com
                    </a>
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action" onclick="sharparp.push({title: 'href',value: 'https://cocohairsignature.com'});"><i class="bi bi-globe"></i> cocohairsignature.com</a>
                    <br />
                    ...
                    <a href="javascript:void(0);" class="list-group-item list-group-item-action signoutClick">
