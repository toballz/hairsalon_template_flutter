  ...
  void getHttpPosters() async {
    ...
    if (mounted) {
      setState(() {
        ...
        popularHairstyleBooked = countStaeeiwts?['popularHairstyleBooked'] ?? 0;
        //print(countStaeeiwts);

        thisMonthCount = int.parse(countStaeeiwts?['beginingOfThisMonth'] ?? 0);
        thisMonthGross = thisMonthCount * 50;
        //
        lastMonthCount = int.parse(countStaeeiwts?['lastMonth'] ?? 0);
        lastMonthGross = lastMonthCount * 50;
        //
        allMonthCount = int.parse(countStaeeiwts?['allToDate'] ?? 0);
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      Column(children: [
                        ListView.builder(
                            shrinkWrap: true,
                            itemCount: popularHairstyleBooked?.length ?? 0,
                            itemBuilder: (BuildContext context, int o) {
                              return ListTile(
                                  ...
                                  title: Text(
                                      popularHairstyleBooked![o]['hairstyle'],
